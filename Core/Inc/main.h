...
#define MCU_STATUS_LED_Pin GPIO_PIN_0
...
#define TS_SNS_Pin GPIO_PIN_4
#define TS_SNS_GPIO_Port GPIOC
#define BRK_Pin GPIO_PIN_0
#define BRK_GPIO_Port GPIOB
#define BUZZER_Pin GPIO_PIN_1
#define BUZZER_GPIO_Port GPIOB
#define STATUS_R_Pin GPIO_PIN_12
...
#define BSPD_TS_SNS_FAULT_GPIO_Port GPIOA
#define BSPD_APPS1_FAULT_Pin GPIO_PIN_10
#define BSPD_APPS1_FAULT_GPIO_Port GPIOC
#define BSPD_APPS2_FAULT_Pin GPIO_PIN_11
#define BSPD_APPS2_FAULT_GPIO_Port GPIOC
#define BSPD_BRK_FAULT_Pin GPIO_PIN_12
#define BSPD_BRK_FAULT_GPIO_Port GPIOC
#define BSPD_TS_BRK_FAULT_Pin GPIO_PIN_2
...
#define ACC_FAN_Pin GPIO_PIN_8
#define ACC_FAN_GPIO_Port GPIOB
